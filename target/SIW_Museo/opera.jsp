...
<title>Nome Opera</title>
<link rel="stylesheet" href="stili/opera.css" />
</head>
<body>
	<nav>
	...
	<section>
		<img src="stili/notteStellata.jpg" width="500px" height="700px"
			hspace="15px" align="left" />
		<section id="paragrafo">
			<p>
			<h1 class="titolo">Nome Opera</h1>
			<div class="descr">
				<a href="artista.jsp" class="descr"> Nome Artista </a>, Data
			</div>
			<p>
			Artista balblablablablabalblablablablabalblablablab
			</p>
		</section>
	</section>
